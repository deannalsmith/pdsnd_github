...
def get_filters():
    ...
    while True:
        fltr = input('Would you like to filter data by month, day, both, or not at all? Type "none" for no time filter.\n').lower()
        if fltr != 'month' and fltr != 'day' and fltr != 'both' and fltr != 'none':
            print('Invalid filter choice, please enter a choice from the list.\n')
            continue
        elif fltr == 'month':
            while True:
                month = input('Which month? January, February, March, April, May, or June? \n').lower()
                if month != 'january' and month != 'february' and month != 'march' and month != 'april' and month != 'may' and month != 'june':
                    print('Invalid month, please enter a choice from the list.\n')
                    continue
                else:
                    day = 'all'
                    break
            ...
            while True:
                ...
                if day != '1' and day != '2' and day != '3' and day != '4' and day != '5' and day != '6' and day != '7':
                    print('Invalid day, please type your response as an integer between 1-7.\n')
                    continue
                else:
                    break
            break
...
def station_stats(df):
    ...
    combo_station = df['Start Station'] + ' / ' + df['End Station']
    common_combo = combo_station.mode()
